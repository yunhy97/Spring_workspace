...
CREATE TABLE user_total_boards(
		...
		userboard_content VARCHAR(2000) NOT NULL,
		userboard_git VARCHAR(100),
		userboard_img VARCHAR(300) DEFAULT gray.jpg,
		userboard_actived CHAR(1) DEFAULT 'N',
		userboard_warning INTEGER DEFAULT 0,
		userboard_like INTEGER DEFAULT 0,
...
CREATE TABLE company_total_boards(
		...
		compboard_address VARCHAR(100),
		compboard_img VARCHAR(300) DEFAULT gray.jpg,
		compboard_actived CHAR(1) DEFAULT 'N',
		compboard_warning INTEGER DEFAULT 0,
		compboard_like INTEGER DEFAULT 0,
...
ALTER TABLE community_contents ADD CONSTRAINT IDX_community_contents_FK0 FOREIGN KEY (commu_no) REFERENCES communities (commu_no);
